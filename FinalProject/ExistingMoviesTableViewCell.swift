//
//  ExistingMoviesTableViewCell.swift
//  FinalProject
//
...
class ExistingMoviesTableViewCell: UITableViewCell {
    
    // MARK: Properties
    
    @IBOutlet weak var ExistingMovieName: UILabel!
    
    @IBOutlet weak var ExistingMovieKey: UILabel!
