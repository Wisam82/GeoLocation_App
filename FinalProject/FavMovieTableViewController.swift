//
//  FavMovieTableViewController.swift
//  FinalProject
//
...
class FavMovieTableViewController: UITableViewController {
...
//        let cell = tableView.dequeueReusableCellWithIdentifier("FavMovieCell", forIndexPath: indexPath) as! UITableViewCell
//        cell.textLabel?.text = TableData[indexPath.row]
//        return cell
        
        let cellIdentifier = "FavMovieCell"
        let cell = tableView.dequeueReusableCellWithIdentifier(cellIdentifier, forIndexPath: indexPath) as! FavMovieTableViewCell
        cell.FavMovieName.text = TableData[indexPath.row]
        cell.FavMovieKey.text = TableDataKeys[indexPath.row]
                    ...
                    if let UserEntry = item as? NSDictionary {
                        ...
                        if let AUser = UserEntry["Username"] as? String{
                            if AUser == LoggedInUser {
                                ...
                                if let FavMovieList = UserEntry["Favorite_Movies"] as? NSArray {
                                    for movie in FavMovieList {
                                        if let movieName = movie["Movie_name"] as? String {
                                            print(movieName);
                                            TableData.append(movieName);
                                        }
                                        if let Movie_Key = movie["Moive_key"] as? NSNumber {
